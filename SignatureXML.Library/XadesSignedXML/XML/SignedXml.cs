...
namespace SignatureXML.Library
{
    public class SignedXml
    {
        ...
        public AsymmetricAlgorithm PublicKeyCert
        {
        ...
        public byte[] ComputeSignature()
        {
            ...
            // Load the key
            AsymmetricAlgorithm key = PublicKeyCert;
        ...
        public void ComputeSignature(KeyedHashAlgorithm macAlg)
        {
            ...
            {
                "SHA1" => XmlDsigHMACSHA1Url,
                "SHA256" => XmlDsigMoreHMACSHA256Url,
                "SHA384" => XmlDsigMoreHMACSHA384Url,
                "SHA512" => XmlDsigMoreHMACSHA512Url,
                "MD5" => XmlDsigMoreHMACMD5Url,
                "RIPEMD160" => XmlDsigMoreHMACRIPEMD160Url,
