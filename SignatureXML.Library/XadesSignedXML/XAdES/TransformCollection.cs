...
namespace SignatureXML.Library
{
	...
	public class TransformCollection : ArrayList
	{
		...
		public new Transform2 this[int index]
		{
			get
			{
				return (Transform2)base[index];
			}
			set
			{
				base[index] = value;
		...
		public Transform2 Add(Transform2 objectToAdd)
		{
		...
		public Transform2 Add()
		{
			return this.Add(new Transform2());
		}
	}
}