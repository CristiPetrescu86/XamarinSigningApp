...
namespace SignatureXML.Library
{
	...
	public class NoticeRef
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "NoticeRef", SignedXml.XadesNamespaceUri);

			if (this.organization == null)
			{
				throw new CryptographicException("Organization can't be null");
			}
            bufferXmlElement = creationXmlDocument.CreateElement("xades", "Organization", SignedXml.XadesNamespaceUri);
