...
namespace SignatureXML.Library
{
	...
	public class Transforms
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "Transforms", SignedXml.XadesNamespaceUri);

			if (this.transformCollection.Count > 0)
			{
				foreach (Transform2 transform in this.transformCollection)
				{
