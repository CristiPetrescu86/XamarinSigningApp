...
namespace SignatureXML.Library
{
	...
	public class NoticeNumbers
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "NoticeNumbers", SignedXml.XadesNamespaceUri);

			if (this.noticeNumberCollection.Count > 0)
			{
				foreach (int noticeNumber in this.noticeNumberCollection)
				{
					bufferXmlElement = creationXmlDocument.CreateElement("int", SignedXml.XadesNamespaceUri);
