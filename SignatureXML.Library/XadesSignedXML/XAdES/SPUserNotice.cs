...
namespace SignatureXML.Library
{
	...
	public class SPUserNotice : SigPolicyQualifier
	{
		...
		public override XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "SigPolicyQualifier", SignedXml.XadesNamespaceUri);

            bufferXmlElement = creationXmlDocument.CreateElement("xades", "SPUserNotice", SignedXml.XadesNamespaceUri);
			if (this.noticeRef != null && this.noticeRef.HasChanged())
			{
			...
			if (!String.IsNullOrEmpty(this.explicitText))
			{
                bufferXmlElement2 = creationXmlDocument.CreateElement("xades", "ExplicitText", SignedXml.XadesNamespaceUri);
