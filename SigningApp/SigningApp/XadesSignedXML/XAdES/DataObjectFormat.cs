...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class DataObjectFormat
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "DataObjectFormat", SignedXml.XadesNamespaceUri);
            ...
            if (!String.IsNullOrEmpty(this.description))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "Description", SignedXml.XadesNamespaceUri);
            ...
            if (!String.IsNullOrEmpty(this.mimeType))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "MimeType", SignedXml.XadesNamespaceUri);
            ...
            if (!String.IsNullOrEmpty(this.encoding))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "Encoding", SignedXml.XadesNamespaceUri);
