...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class CounterSignatureCollection : ArrayList
	{
		...
		public new SignedXml this[int index]
		{
			get
			{
				return (SignedXml)base[index];
			}
			set
			{
				base[index] = value;
		...
		public SignedXml Add(SignedXml objectToAdd)
		{
		...
		public SignedXml Add()
		{
			return this.Add(new SignedXml());
		}
	}
}