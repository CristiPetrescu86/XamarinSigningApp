...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class SignatureProductionPlace
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "SignatureProductionPlace", SignedXml.XadesNamespaceUri);

			if (!String.IsNullOrEmpty(this.city))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "City", SignedXml.XadesNamespaceUri);
			...
			if (!String.IsNullOrEmpty(this.stateOrProvince))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "StateOrProvince", SignedXml.XadesNamespaceUri);
			...
			if (!String.IsNullOrEmpty(this.postalCode))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "PostalCode", SignedXml.XadesNamespaceUri);
			...
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "CountryName", SignedXml.XadesNamespaceUri);
