...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class SignaturePolicyIdentifier
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "SignaturePolicyIdentifier", SignedXml.XadesNamespaceUri);

			if (this.signaturePolicyImplied)
			{ //Append empty element as required
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "SignaturePolicyImplied", SignedXml.XadesNamespaceUri);
