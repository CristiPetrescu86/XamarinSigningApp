...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class CommitmentTypeIndication
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "CommitmentTypeIndication", SignedXml.XadesNamespaceUri);
			...
			{ //Add emty element as required
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "AllSignedDataObjects", SignedXml.XadesNamespaceUri);
