...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class CertificateValues
	{
		...
		public void LoadXml(System.Xml.XmlElement xmlElement)
		{
			...
			xmlNamespaceManager.AddNamespace("xades", SignedXml.XadesNamespaceUri);
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "CertificateValues", SignedXml.XadesNamespaceUri);
			if (this.id != null && this.id != "")
			{
