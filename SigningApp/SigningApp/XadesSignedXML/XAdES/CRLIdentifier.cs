...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class CRLIdentifier
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "CRLIdentifier", SignedXml.XadesNamespaceUri);

			retVal.SetAttribute("URI", this.uriAttribute);

			if (!String.IsNullOrEmpty(this.issuer))
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "Issuer", SignedXml.XadesNamespaceUri);
			...
			if (this.issueTime != DateTime.MinValue)
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "IssueTime", SignedXml.XadesNamespaceUri);
			...
			if (this.number != long.MinValue)
			{
                bufferXmlElement = creationXmlDocument.CreateElement("xades", "Number", SignedXml.XadesNamespaceUri);
