...
namespace SigningApp.XadesSignedXML.XML
{
	...
	public class SignedSignatureProperties
	{
		...
		public XmlElement GetXml()
		{
            ...
            retVal = creationXmlDocument.CreateElement("xades", "SignedSignatureProperties", SignedXml.XadesNamespaceUri);

			if (this.signingTime == DateTime.MinValue)
			{ //SigningTime should be available
				this.signingTime = DateTime.Now;
			}
            bufferXmlElement = creationXmlDocument.CreateElement("xades", "SigningTime", SignedXml.XadesNamespaceUri);
